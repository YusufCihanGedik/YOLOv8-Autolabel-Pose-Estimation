...
OUTPUT_DIR = r'C:\Users\Gedik\Desktop\ComputerVision\DeepLearning\yolov8-pose\yolov8pose_output\kesim_1'
...
# Sınıf kategorilerinin eklenmesi
categories = [
    {"id": 1, "name": "person", "supercategory": "pose"},
    {"id": 2, "name": "machine", "supercategory": "object"}
]

def process_video(video_path, model, frame_skip=1, images_per_folder=1000):
    ...
    for i in range(len(boxes)):
        ...
        if num_valid_keypoints > 0: 
            annotation = {
                "id": annotation_id,
                "image_id": image_id,
                "category_id": 1,  # Buraya sınıf kategorisini dinamik olarak ekleyebilirsin
                "bbox": bbox,
                "area": bbox[2] * bbox[3],
                "iscrowd": 0,
